...
class Client:
    ...
    def CheckCards(self):
        ...
        #de fiecare daca cand se creaza un card se creaza pentru toate obiectele de tipul Client.
        ...
        if(len(self.CardsOnAccount) == 0 or cardsAcc == 0):
            ...
            for i in range(len(self.CardsOnAccount)):
                if(self.CardsOnAccount[i].owner == self.username):
                    print(self.CardsOnAccount[i].cardName, "-",self.CardsOnAccount[i].moneyOnCard,"$")
            os.system("pause")
